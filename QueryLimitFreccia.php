...
?>
<a href=" <?php print $_SERVER["PHP_SELF"] ."?records=$NumberOfRecords&page=0"?> "> first</a>
<!-- //Prev andiamo semplicemnte a ridure current page di -1 -->
<a href="<?php print $_SERVER['PHP_SELF']  ."?records=$NumberOfRecords&page=" .$CurrentPage-1 ?>">Prev</a>
...
<a href= "<?php print $_SERVER["PHP_SELF"] ."?records=$NumberOfRecords&page=" .$CurrentPage +1?>">next</a>
<a href="<?php print $_SERVER['PHP_SELF']  ."?records=$NumberOfRecords&page=" .$pages-1 ?>">Last</a>
